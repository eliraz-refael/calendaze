defmodule CalenDazeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CalenDazeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CalenDazeWeb.Gettext, "errors", msg, opts)
    end
  end
